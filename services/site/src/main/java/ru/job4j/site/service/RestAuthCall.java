...
/**
 * В классе применяем RestTemplateResponseErrorHandler
 * при создании бина (поля) с RestTemplate с помощью
 * RestTemplateBuilder.
 * Теперь при получении ошибки типов 4хх и 5хх,
 * бин RestTemplate генерирует исключение IdNotFoundException,
 * BadRequestException, NullPointerException, IllegalArgumentException
 * которые обрабатываются в GlobalExceptionHandler.
 */
